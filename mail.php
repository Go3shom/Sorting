...
try {
    ...
    $mail->Username   = 'shadi.muhammad001@gmail.com';                     // SMTP username
    $mail->Password   = 'pass123';                               // SMTP password
    $mail->SMTPSecure = 'tls';                                  // Enable TLS encryption, `ssl` also accepted
    $mail->Port       = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('shadi.muhammad001@gmail.com', 'Mailer');
    $mail->addAddress('shadi.muhammad001@gmail.com', 'Joe User');     // Add a recipient
